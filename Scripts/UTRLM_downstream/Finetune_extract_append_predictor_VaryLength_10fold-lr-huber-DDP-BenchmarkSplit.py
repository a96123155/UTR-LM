...
print('====Load Data====')
train_data = pd.read_csv(f'/home/ubuntu/human_5utr_modeling-master/data/VaryLengthRandomTrain_sequence.csv')
test_random_data = pd.read_csv(f'/home/ubuntu/human_5utr_modeling-master/data/VaryLengthRandomTest_sequence.csv')
    ...
    for epoch in trange(args.init_epochs+1, args.init_epochs + args.epochs + 2):
        ...
        ##### results
            ...
            if epoch == 1 or epoch % args.log_interval == 0 or epoch == args.init_epochs+1 or epoch >= args.init_epochs + args.epochs:
                ...
                e_random_pred.to_csv(f'/home/ubuntu/esm2/Sample/y_pred/{filename}_testrandom_fold{i}.csv', index = False)
                e_human_pred.to_csv(f'/home/ubuntu/esm2/Sample/y_pred/{filename}_testhuman_fold{i}.csv', index = False)
