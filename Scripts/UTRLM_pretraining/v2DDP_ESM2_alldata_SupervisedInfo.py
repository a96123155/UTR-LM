...
outputfilename = f'{prefix}_{args.cell_line}_{layers}layers_{heads}heads_{embed_dim}embedsize_{batch_toks}batchToks_lr{args.lr}_supervisedweight{args.supervised_weight}'
...
#             f'>{energy}|{structure}|{energy_normal}\n{seq}\n'
...
#                 print(f'Epoch = {epoch}: MLM Loss = {loss_mlm:.4f}')
    ...
    print(f'Epoch = {epoch}: MLM Loss = {loss_mlm_epoch:.4f} | Supervised Loss = {loss_supervised_epoch:.4f}')
